    ...
    IMultiwrap
{
    ...
    struct UnjustBrick {
      ...
      /// Flag to 
      bool isUnwrapped;
      /// The time that the NFT was initially minted
      uint256 timestamp;
      /// Whether wrapped NFT exists.
      bool isInitialized;
    }

    // Flag to activate wrapper
    ...
    function wrap(
        ...
        // todo Need to create a map of justbricks instead of iterating
